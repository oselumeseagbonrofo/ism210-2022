...
const HelloWorld4: React.FC<Props> = ({ name = "Aluya" }) => {
    ...
    return (
        <div className='flex flex-col space-y-3'>
            <p>Hello {nameToGreet}. This illustrates multiple state managed variables in a single React Component. HelloWorld4</p>
            <p>
